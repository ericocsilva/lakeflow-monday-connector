...
# MAGIC %md
# MAGIC # Monday.com → Unity Catalog (External Tables — Classic Compute)
...
dbutils.widgets.text("checkpoint_base",        "/dbfs/checkpoints/lakeflow/monday_external",            "Checkpoint Base (DBFS)")
